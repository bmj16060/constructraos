...
2. Add durable records for gate execution and outcomes.
3. Implement workflow routing based on gate pass/fail/block results.
4. Connect review acceptance to the verification and promotion path.
5. Verify that unsafe or unverified changes cannot progress automatically.
